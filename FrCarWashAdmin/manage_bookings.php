     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content">
                ...
                <a href="add_booking.php" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Tambah Pemesanan Baru</a>

                <?php
                // Tampilkan pesan status dari operasi CRUD (misal setelah delete)
                if (isset($_GET['status'])) {
                    if ($_GET['status'] == 'success_delete') {
                        echo '<div class="alert alert-success" role="alert">Pemesanan berhasil dihapus!</div>';
                    } elseif ($_GET['status'] == 'error_delete') {
                        echo '<div class="alert alert-danger" role="alert">Gagal menghapus pemesanan: ' . htmlspecialchars($_GET['message'] ?? 'Terjadi kesalahan.') . '</div>';
                    } elseif ($_GET['status'] == 'success_add') {
                        echo '<div class="alert alert-success" role="alert">Pemesanan baru berhasil ditambahkan!</div>';
                    } elseif ($_GET['status'] == 'success_edit') {
                        echo '<div class="alert alert-success" role="alert">Pemesanan berhasil diperbarui!</div>';
                    }
                }
                ?>
